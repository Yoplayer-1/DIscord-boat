...
sad_words = [
    "sad", "sed", "depressed", "unhappy", "angry", "miserable", "depressing"
]
...
starter_encouragements = [
    ...
    "Happy Time :)", 
    "Happy with parties here's a *Cheer Up* party for You. PARTY TIME :partying_face:"
]
    ...
    if db["responding"]:
        ...
        if "exam" in msg:
            await message.channel.send(
                "Exams!!! hang in there study more be happy :)")
